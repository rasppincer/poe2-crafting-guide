...
mod_pool_weight_sum(body_armour_str_int, prefix, 6500).
...
mod_group(body_armour_str_int, 'PercentIncreasedArmourAndEnergyShield', '#% increased Armour and Energy Shield', [energy_shield, armour], 1000, 100, 8, prefix).
mod_group(body_armour_str_int, 'FlattoArmourFlattoMaximumEnergyShieldPercentIncreasedArmourAndEnergyShield', '# to Armour, # to maximum Energy Shield, #% increased Armour and Energy Shield', [energy_shield, armour], 1000, 100, 6, prefix).
mod_group(body_armour_str_int, 'PercentIncreasedArmourAndEnergyShieldFlattoMaximumLife', '#% increased Armour and Energy Shield, # to maximum Life', [life, energy_shield, armour], 1000, 100, 6, prefix).
mod_group(body_armour_str_int, 'FlattoArmourFlattoMaximumEnergyShield', '# to Armour, # to maximum Energy Shield', [energy_shield, armour], 1000, 100, 8, prefix).
mod_group(body_armour_str_int, 'FlattoMaximumLife', '# to maximum Life', [life], 1000, 100, 13, prefix).
mod_group(body_armour_str_int, 'FlattoSpirit', '# to Spirit', [], 500, 100, 8, prefix).

mod_group(body_armour_str_int, 'FlatLifeRegenerationPerSecond', '# Life Regeneration per second', [life, regeneration], 1000, 100, 11, suffix).
mod_group(body_armour_str_int, 'PercentReducedAttributeRequirements', '#% reduced Attribute Requirements', [], 900, 100, 5, suffix).
...
mod_group(body_armour_str_int, 'FlattoStunThreshold', '# to Stun Threshold', [stun], 800, 100, 10, suffix).
