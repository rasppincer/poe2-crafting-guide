...
mod_group(shield_str_dex, PercentIncreasedArmourAndEvasionFlattoStunThreshold, '#% increased Armour and Evasion, # to Stun Threshold', [armour, evasion], 1000, 100, 6, prefix).
...
mod_group(shield_str_dex, PercentReducedAttributeRequirements, '#% reduced Attribute Requirements', [attribute], 800, 100, 5, suffix).
...
mod_group(shield_str_dex, FlattoStunThreshold, '# to Stun Threshold', [], 800, 100, 10, suffix).
