...
mod_group(shield_str, 'PercentIncreasedArmourFlattoStunThreshold', '#% increased Armour, # to Stun Threshold', [armour, stun], 1000, 100, 6, prefix).
...
mod_group(shield_str, 'PercentReducedAttributeRequirements', '#% reduced Attribute Requirements', [], 800, 100, 5, suffix).
mod_group(shield_str, 'FlattoStrength', '# to Strength', [attribute], 1000, 100, 8, suffix).
mod_group(shield_str, 'FlattoStunThreshold', '# to Stun Threshold', [stun], 800, 100, 10, suffix).
