...
mod_pool_weight_sum(body_armour_int, prefix, 6100).
...
mod_group(body_armour_int, FlattoSpirit, '# to Spirit', [spirit], 100, 100, 8, prefix).
mod_group(body_armour_int, FlatLifeRegenerationPerSecond, '# Life Regeneration per second', [life], 1000, 100, 11, suffix).
mod_group(body_armour_int, PercentReducedAttributeRequirements, '#% reduced Attribute Requirements', [attribute], 900, 100, 5, suffix).
...
mod_group(body_armour_int, FlattoStunThreshold, '# to Stun Threshold', [], 800, 100, 10, suffix).
