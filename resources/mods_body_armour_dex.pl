...
mod_pool_weight_sum(body_armour_dex, prefix, 6100).
...
mod_group(body_armour_dex, FlattoSpirit, '# to Spirit', [spirit], 100, 100, 8, prefix).
mod_group(body_armour_dex, FlatLifeRegenerationPerSecond, '# Life Regeneration per second', [life], 1000, 100, 11, suffix).
mod_group(body_armour_dex, PercentReducedAttributeRequirements, '#% reduced Attribute Requirements', [attribute], 900, 100, 5, suffix).
...
mod_group(body_armour_dex, FlattoStunThreshold, '# to Stun Threshold', [], 800, 100, 10, suffix).
