...
mod_pool_weight_sum(body_armour_str_dex, prefix, 6500).
...
mod_group(body_armour_str_dex, 'FlattoSpirit', '# to Spirit', [], 500, 100, 8, prefix).

mod_group(body_armour_str_dex, 'FlatLifeRegenerationPerSecond', '# Life Regeneration per second', [life, regeneration], 1000, 100, 11, suffix).
mod_group(body_armour_str_dex, 'PercentReducedAttributeRequirements', '#% reduced Attribute Requirements', [], 900, 100, 5, suffix).
...
mod_group(body_armour_str_dex, 'FlattoStunThreshold', '# to Stun Threshold', [stun], 800, 100, 10, suffix).
