...
mod_pool_weight_sum(body_armour_dex_int, prefix, 6500).
...
mod_group(body_armour_dex_int, 'PercentIncreasedEvasionAndEnergyShield', '#% increased Evasion and Energy Shield', [energy_shield, evasion], 1000, 100, 8, prefix).
mod_group(body_armour_dex_int, 'FlattoEvasionRatingFlattoMaximumEnergyShieldPercentIncreasedEvasionAndEnergyShield', '# to Evasion Rating, # to maximum Energy Shield, #% increased Evasion and Energy Shield', [energy_shield, evasion], 1000, 100, 6, prefix).
mod_group(body_armour_dex_int, 'PercentIncreasedEvasionAndEnergyShieldFlattoMaximumLife', '#% increased Evasion and Energy Shield, # to maximum Life', [life, energy_shield, evasion], 1000, 100, 6, prefix).
mod_group(body_armour_dex_int, 'FlattoEvasionRatingFlattoMaximumEnergyShield', '# to Evasion Rating, # to maximum Energy Shield', [energy_shield, evasion], 1000, 100, 8, prefix).
mod_group(body_armour_dex_int, 'FlattoMaximumLife', '# to maximum Life', [life], 1000, 100, 13, prefix).
mod_group(body_armour_dex_int, 'FlattoSpirit', '# to Spirit', [], 500, 100, 8, prefix).

mod_group(body_armour_dex_int, 'FlatLifeRegenerationPerSecond', '# Life Regeneration per second', [life, regeneration], 1000, 100, 11, suffix).
mod_group(body_armour_dex_int, 'PercentReducedAttributeRequirements', '#% reduced Attribute Requirements', [], 900, 100, 5, suffix).
...
mod_group(body_armour_dex_int, 'FlattoStunThreshold', '# to Stun Threshold', [stun], 800, 100, 10, suffix).
