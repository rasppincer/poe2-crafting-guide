...
mod_group(buckler, 'PercentIncreasedEvasionRatingFlattoStunThreshold', '#% increased Evasion Rating, # to Stun Threshold', [evasion, stun], 1000, 100, 6, prefix).
...
mod_group(buckler, 'PercentReducedAttributeRequirements', '#% reduced Attribute Requirements', [], 800, 100, 5, suffix).
mod_group(buckler, 'FlattoDexterity', '# to Dexterity', [attribute], 1000, 100, 8, suffix).
mod_group(buckler, 'FlattoStunThreshold', '# to Stun Threshold', [stun], 800, 100, 10, suffix).
